...
require_once JPATH_ROOT.'/plugins/api/articlesij/articlesij/blogs/blog/post.php';
require_once JPATH_ROOT.'/plugins/api/articlesij/articlesij/blogs/category.php';
require_once JPATH_ROOT.'/plugins/api/articlesij/articlesij/helper/contenthelper.php';
