...
require_once JPATH_SITE.'/plugins/api/articlesij/articlesij/blogs/category.php';
require_once JPATH_SITE.'/plugins/api/articlesij/articlesij/blogs/person.php';
