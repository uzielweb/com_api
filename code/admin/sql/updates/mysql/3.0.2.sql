...
ALTER TABLE `#__api_logs` CHANGE `id` `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `#__api_logs` CHANGE `time` `time` VARCHAR(19) NOT NULL DEFAULT '';
ALTER TABLE `#__api_logs` CHANGE `request_method` `request_method` varchar(10) NOT NULL DEFAULT '';
